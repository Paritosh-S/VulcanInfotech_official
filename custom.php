...
<!--<div class="g-follow" data-annotation="vertical-bubble" annotation="vertical-bubble" data-height="24" data-href="//plus.google.com/u/0/104491286559844272356" data-rel="publisher"></div>-->
			...
			<div class="row">
				...
				<div class="col-md-6 content-about-grid-right">					
						<p style="color: #666666;font-size: 15px;font-weight: 400;line-height: 1.5em;width: 84%;">
							Integrated customs management systems are designed to support import and export processes, speed up transactions and reduce the costs involved in international trade. They improve compliance with the legal requirements that govern international trade, and facilitate greater cooperation in:<br></p>
<ul style="list-style-type: square;color: #666666;font-size: 15px;font-weight: 400;line-height: 1.5em;width: 84%; margin-left:30px;" >
<li>Customs processing</li>
<li>Transit and presentation</li>
<li>Classification</li>
<li>Electronic communication and document printing</li>
</ul>	
<p style="color: #666666;font-size: 15px;font-weight: 400;line-height: 1.5em;width: 84%;">More than 85 countries worldwide have implemented customs management systems to enable customs to discharge its fiscal and control responsibilities more effectively.</p>
			...
			<div class="gallery-bottom">
					<div class="col-md-4 gal-grid">
						<div class="view view-fifth">
							<a class="b-link-stripe b-animate-go  thickbox"><img src="images/sales.png "alt="" class="img-responsive" style="height:250px;">
								<div class="mask" style="background-color:#f8f8ff;">
									<h4>SALES PIPELINE</h4>
									<p style="color:black;">Every sales pipeline is different. Base highlights this with Sales Pipeline Management tools that are tailored to your needs.</p>
					...
					<div class="col-md-4 gal-grid">
						<div class="view view-fifth">
						   <a class="b-link-stripe b-animate-go  thickbox"  ><img src="images/Banner_880x265_Inventory.jpg" alt="" class="img-responsive" style="height:200px;">
								<div class="mask" style="background-color:#f8f8ff;" >
									<h4 style="font-size:15px;"><b>ENVENTRY PROJECT &  MANAGEMENT SYSTEM</b></h4>
									<p  style="color:black;">inventory management you can manage the resources of your company.<br>
Customs management systems from SGS improve transparency and communication.</p>
					...
					<div class="col-md-4 gal-grid">
						<div class="view view-fifth">
							<a class=" b-animate-go  thickbox"  ><img src="images/payroll.jpg" alt="" class="img-responsive" style="height:200px;">
								<div class="mask" style="background-color:#f8f8ff;" >
									<h4>PAYROLL & BILLING</h4>
									<p style="color:black;" >The Payroll Management System deals with the financial aspects of employee's salary.<br>
 BRM billing is based on monthly cycles. Each account's bill unit has a billing day of month.</p>
