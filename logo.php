...
<link rel="shortcut icon" type="image/x-icon" href="images/vulcan_favicon.ico" />
    <link rel="icon" type="image/x-icon" href="images/vulcan_favicon.ico" />
		<script>
...
<div class="container">
	<div class="header">
		...
		<ul class="menu list-unstyled">
			...
			<li><a href="contactus.php">CONTACT</a></li>		</ul>
		</nav>
...
<div class="team-top">
			...
			<div class="row">
				<div class="col-md-6 content-about-grid-left">
					<img src="images/best_web_design_trichy.png">
				</div>
				<div class="col-md-6 content-about-grid-right">					
						<p style="color: #666666;font-size: 15px;font-weight: 400;line-height: 1.5em;width: 84%;">
							 A logo is a brand identity image, or a tag of a company or product. A logo is a tangible concept that provides a company with a visual image, and that fosters recognition by consumers.<br>
							<b>Our expertise in area of web designing:</b><br></p>
<ul style="list-style-type: square;color: #666666;font-size: 15px;font-weight: 400;line-height: 1.5em;width: 84%; margin-left:30px;" >
<li>Website Designing in Flash</li>
<li>Logo Designing</li>
<li>Flyers, Advertisement, Banner Designing</li>
<li>Photograph Editing & Retouching</li>
<li>Flash Banner Designing</li>
<li>Cartoon Animation Development
			...
			<div class="row">
					...
					<div class="col-md-4 gal-grid">
						<div class="view view-fifth">
						   <a class="b-link-stripe b-animate-go  thickbox"  ><img src="images/logo-design.png" alt="" class="img-responsive" style="height:200px;">
								<div class="mask" style="background-color:#f8f8ff;" >
									<h4>LOGO DESIGN</h4>
									<p  style="color:black;">A logo is a sketched or graphically designed symbol,set in a specific typeface or font, and arranged in a unique way, with distinct colors, shapes, and designs to represent a company</p>
					...
					<div class="col-md-4 gal-grid">
						<div class="view view-fifth">
							<a class=" b-animate-go  thickbox"  ><img src="images/f3-template-design-head.jpg" alt="" class="img-responsive" style="height:200px;">
								<div class="mask" style="background-color:#f8f8ff;" >
									<h4>TEMPLATE DESIGN</h4>
									<p style="color:black;" >A web design template or a website design template is a template which is in most cases used to present some information in the Internet.</p>
