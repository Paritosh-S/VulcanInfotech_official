		...
		<div class="container"  >
			...
			<div class="row" style="margin-top:80px;">
				<div class="col-md-6 content-about-grid-left">
					<img src="images/mobile-responsive-web-design.png">
				</div>
				<div class="col-md-6 content-about-grid-right">					
						<p style="color: #666666;font-size: 15px;font-weight: 400;line-height: 1.5em;width: 84%;">
							<b>Why should businesses consider  web development?</b><br>
								web design covers the graphics and layout of your site, web development is the core coding that holds your web applications together. </br>
							
							<b>We are expert in:</b></p>
<ul style="list-style-type: square;color: #666666;font-size: 15px;font-weight: 400;line-height: 1.5em;width: 84%; margin-left:30px;" >
<li>Develop web application using PHP, Silverlight, Flash / Flex</li>
<li>B2B, B2C web application development</li>
<li>Product Development</li>
<li>Programming for Web Service</li>
<li>E-commerce (custom shopping cart) Solution</li>
<li>Website development that meets web 2.0 standards!</li>
</ul>
...
<div class="row">
					<div class="col-md-4 gal-grid ">
						<div class="view view-fifth">
							<a class=" b-animate-go  thickbox"><img src="images/images.png "alt="" class="img-responsive" style="height:200px;">
								<div class="mask" style="background-color:#f8f8ff;">
									<h4>CMS</h4>
									<p style="color:black;"> A CMS  quite literally allows you to control and manage the content within your web site - without technical training.</p>
					...
					<div class="col-md-4 gal-grid ">
						<div class="view view-fifth">
						   <a class=" b-animate-go  thickbox"  ><img src="images/php.png" alt="" class="img-responsive" style="height:200px;">
								<div class="mask" style="background-color:#f8f8ff;" >
									<h4>PHP</h4>
									<p  style="color:black;"> PHP is a widely-used open source general-purpose scripting language that is especially suited for web development and can be embedded into HTML..</p>
					...
					<div class="col-md-4 gal-grid ">
						<div class="view view-fifth">
							<a class=" b-animate-go  thickbox"  ><img src="images/asp.net_.png" alt="" class="img-responsive" style="height:200px;">
								<div class="mask" style="background-color:#f8f8ff;" >
									<h4>ASP.NET</h4>
									<p style="color:black;" >ASP.NET is a web development platform, which provides a programming model, a comprehensive software infrastructure and various services required to build up robust web applications for PC.</p>
